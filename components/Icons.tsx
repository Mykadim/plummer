export function VerifiedIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 14.59L6.41 12 8 10.41l3 3 7-7L19.59 8l-8.59 8.59z" />
    </svg>
  );
}
...
export function ChevronIcon({ direction = "right", className = "w-5 h-5" }: { direction?: "left" | "right"; className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
